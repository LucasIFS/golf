...
function my_keydown(e)
{
	...
	function up()
	{
		...
		(
			...
			console.log("altora do bloco da Imagem = " + block_image_height);
	...
	function left()
	{
		if(ball_x >=5)
		{
			...
			console.log("altora do bloco da Imagem = " + block_image_Width);
			console.log("quando a seta para baixo é pressionada, Y = " + ball_y + " , X = "+ball_x);
			canvas.remove(ball_obj);
			new_image();
		}
	}
